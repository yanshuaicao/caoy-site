...
BLOG_AUTHOR = "Yanshuai Cao"
BLOG_TITLE = "Yanshuai Cao"
# This is the main URL for your site. It will be used
# in a prominent link
SITE_URL = "http://www.cs.toronto.edu/"
# This is the URL where nikola's output will be deployed.
# If not set, defaults to SITE_URL
BASE_URL = "http://www.cs.toronto.edu/~caoy/"
BLOG_EMAIL = "caoy@cs.toronto.edu"
BLOG_DESCRIPTION = ""
...
# Default is:
FILES_FOLDERS = {'files': '' ,
                 'pages/opt_sgpr/resources':'opt_sgpr'}
...
<script type="text/javascript">
  ...
  ga('create', 'UA-45595054-1', 'toronto.edu');
  ga('send', 'pageview');
